...
task_for_pid: 96700bb0b0bd00bff0b503af2de9000d a6
select f0
...
void offsets_init(void){
    ...
    if([isA5orA5X containsObject:[NSString stringWithCString:systemInfo.machine encoding:NSUTF8StringEncoding]]) { //detect if A5/A5X or A6/A6X
        ...
        if ([@"2784.20.34~2" isEqualToString:kver]) {
            ...
            olog("We're using 8.3 A5/A5X offsets...\n");
        }
        if ([@"2783.5.38~5" isEqualToString:kver]) {
            offsets = koffsets_S5L894xX_820;
            olog("We're using 8.2 A5/A5X offsets...\n");
        }
        if ([@"2783.3.26~3" isEqualToString:kver]) {
            offsets = koffsets_S5L894xX_813;
            olog("We're using 8.1.3 A5/A5X offsets...\n");
        }
        if ([@"2783.3.22~1" isEqualToString:kver]) {
            offsets = koffsets_S5L894xX_812;
            olog("We're using 8.1.2 A5/A5X offsets...\n");
        }
        if ([@"2783.3.13~4" isEqualToString:kver]) {
            offsets = koffsets_S5L894xX_810;
            olog("We're using 8.1 A5/A5X offsets...\n");
        }
        if ([@"2783.1.72~23" isEqualToString:kver]) {
            offsets = koffsets_S5L894xX_802;
            olog("We're using 8.0.2 A5/A5X offsets...\n");
        }
        if ([@"2783.1.72~8" isEqualToString:kver]) {
            offsets = koffsets_S5L894xX_802;
            olog("We're using 8.0.2 A5/A5X offsets...\n");
        }
    } else {
        ...
        if ([@"2783.5.38~5" isEqualToString:kver]) {
            ...
            olog("We're using 8.2 A6/A6X offsets...\n");
        }
        if ([@"2783.3.26~3" isEqualToString:kver]) {
            offsets = koffsets_S5L895xX_813;
            olog("We're using 8.1.3 A6/A6X offsets...\n");
        }
        if ([@"2783.3.22~1" isEqualToString:kver]) {
            offsets = koffsets_S5L895xX_812;
            olog("We're using 8.1.2 A6/A6X offsets...\n");
        }
        if ([@"2783.3.13~4" isEqualToString:kver]) {
            offsets = koffsets_S5L895xX_810;
            olog("We're using 8.1 A6/A6X offsets...\n");
        }
        if ([@"2783.1.72~23" isEqualToString:kver]) {
            offsets = koffsets_S5L895xX_802;
            olog("We're using 8.0.2 A6/A6X offsets...\n");
        }
        if ([@"2783.1.72~8" isEqualToString:kver]) {
            offsets = koffsets_S5L895xX_802;
            olog("We're using 8.0.2 A6/A6X offsets...\n");
